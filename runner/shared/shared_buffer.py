...
from runner.shared.util import get_shape_from_obs_space, get_shape_from_act_space
...
class SharedReplayBuffer(object):
    ...
    def __init__(self, args, num_agents, obs_space, cent_obs_space, act_space):
        ...
        if act_space.__class__.__name__ == 'Discrete':
            ...
            self.available_actions = np.ones((self.episode_length + 1, self.n_rollout_threads, num_agents, settings.uav_num + 1),
                                             dtype=np.float32)
    ...
    def insert(self, share_obs, obs, rnn_states_actor, rnn_states_critic, actions, action_log_probs,
               value_preds, rewards, masks, bad_masks=None, active_masks=None, available_actions=None, objects=None):
        ...
        self.objects[self.step] = objects.copy()
