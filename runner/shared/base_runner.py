...
class Runner(object):
    ...
    def __init__(self, config):
        ...
        self.num_agents = settings.uav_num
        ...
        if settings.algorithm == 'OHM':
            settings.hop_limit = 2

        if settings.algorithm != 'rl' and settings.algorithm != 'OHM':
            return
        ...
        elif self.algorithm_name == 'mappo' or self.algorithm_name == 'rmappo' or self.algorithm_name == 'ippo':
            from onpolicy.algorithms.r_mappo.r_mappo import R_MAPPO as TrainAlgo
            from onpolicy.algorithms.r_mappo.algorithm.rMAPPOPolicy import R_MAPPOPolicy as Policy
        elif self.algorithm_name == 'maddpg':
            from onpolicy.algorithms.maddpg.R_MADDPG import R_MADDPG as TrainAlgo
            from onpolicy.algorithms.maddpg.R_MADDPGPolicy import R_MADDPGPolicy as Policy
